...
% items 4 and 17.
Three simplifications of the reduced model were found after the results above
...
$\CorrArgmaxOneTwenty^\circ$; the narrowest frame, first at $120^\circ$ in
...
family, and it acts on the axis the rotors control most weakly. Roll authority on
its own does favour the narrow frames: without any gyroscopic coupling, the
narrowest frame is the fastest of the three tested at $90^\circ$.
...
of it. The second separated plant from controller on the yaw axis. The yaw torque
...
most. Nor does the coupling act through heading lag or crab at the gates. Flown at
the same speed with and without it, just below its limit, the narrow frame's heading
error at the gates changes by a factor of \GyHeadingNarrowNinety{} at $90^\circ$
and \GyHeadingNarrowOneTwenty{} at $120^\circ$, and its crab angle by
...
for the corrected model, and the heading figures quoted above (yaw amplitude,
sideslip, roll and pitch excursions) were measured on the reduced model only.
