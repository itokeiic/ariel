...
$I_{xx}+I_{yy}$. Euler's equations then make the gyroscopic accelerations about
...
Roll authority alone does not make the narrow frames faster on these courses:
without any gyroscopic coupling, the narrowest frame ties the X quad at $90^\circ$
(\SI{\GyNoneNarrowNinety}{\metre\per\second} against \SI{\GyNoneXNinety}{\metre\per\second})
and trails it at $120^\circ$ (\SI{\GyNoneNarrowOneTwenty}{\metre\per\second} against
...
one body axis at a time. The yaw axis alone reproduces
...
frame's gain at $120^\circ$. The second separated plant from controller on the yaw axis. The yaw torque
...
Figures, both results tables and every number quoted inline
